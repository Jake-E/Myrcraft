...
public class MyrcraftItems
{
    ...
    public static final RegistryObject<Item> RUBBER_SAPLING = ITEMS.register("rubbersapling", () -> new BlockItem(MyrcraftBlocks.RUBBER_SAPLING.get(), ITEM_GROUP));
    public static final RegistryObject<Item> RUBBER_LEAVES = ITEMS.register("rubberleaves", () -> new BlockItem(MyrcraftBlocks.RUBBER_LEAVES.get(), ITEM_GROUP));
